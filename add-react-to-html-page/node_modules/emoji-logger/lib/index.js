...
emojiLogger.log = function (msg, type, override) {
    ...
    type.stream.write(indento(colorIt(message)[type.color]().toString(), type.indent) + "\n");
};
...
// Add the core types
emojiLogger.add("success", "heavyCheckMark", "green");

emojiLogger.add("error", "x", "red");

emojiLogger.add("warn", "warning", "orange");

emojiLogger.add("info", "informationSource", "blue");
